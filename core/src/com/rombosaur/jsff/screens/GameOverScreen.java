...
public class GameOverScreen extends Screen {
    ...
    public void draw(SpriteBatch sb, ShapeRenderer sr) {
        ...
        rectangleRenderer.drawFilled(sb, 0,0,App.WIDTH, App.HEIGHT, Pico8Colors.RED);
        ...
        writer.writeBorderShadow(sb, "gobjects over", titleY, Pico8Colors.RED, Pico8Colors.BLACK, Pico8Colors.DARK_PURPLE);
        writer.write(sb, "you lost", subtitleY, Pico8Colors.WHITE);
